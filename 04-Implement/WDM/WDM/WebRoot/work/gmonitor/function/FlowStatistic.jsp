...
<%
  	...
  	List colList = JSPAction.getAllColomnList("CATE_3_1_2");
				...
				<tr height="500">
					<td width="40%" valign="top" class="tableRegion_bottom" height="500">
						<ec:table items="result"
							...
							title="流量统计" filterable="true" sortable="true">
...
<script>
		...
		function refreshColomn(selectCols){
			var url="<%=contextPath%>/DashBoard.do?method=getFlowStatisticByDevice&selectCols="+selectCols+"&devSn="+<%=devSn%>;
 			this.location = url;
		}
