...
<head>
	...
	<script type="text/javascript">
		function doSubmit(){	
			if(!testRegExp("apgroup",document.getElementById("wlanGroup").value)){
...
<table id="main" width="100%" border="0" cellspacing="0" cellpadding="0" class="tableRegion">
	<tr>
		<html:form action="/DashBoard.do?method=addWlanGroup" onsubmit="return doSubmit();">
			<td valign="top">
				<table width="100%" height="100%" border="0" cellspacing="0"
					...
					<tr height="500">
						<td width="40%" valign="top" class="tableRegion_bottom" height="500">
							...
							<table width="100%">
								<tr width="100%">
								  <td class="item" width="200px">WLAN分组ID</td>
								  <td class="value"><input class="value_text" readonly="true" type="text" name="sn" 
								  		value="<%=nextSeq%>" width="200"> 系统自动生成</td>
								</tr>   
								<tr>
								  <td class="item" width="200px">WLAN分组名</td>
								  <td class="value"><input class="value_text" type="text" name="wlanGroup" 
